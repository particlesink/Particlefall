...
:doc:`written to a dump file <dump>` or accessed by other :ref:`output commands <howto_8>` that use per-atom quantities.
...
:ref:`output commands <howto_8>`.  The number of columns
