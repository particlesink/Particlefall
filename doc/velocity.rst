...
The *setAngular* is simular to *set*\ , however, sets the angular 
momentum.
...
The *ramp* style makekes velocities ramped
...
The *units* option is used by *set*\ , *setAngular* and *ramp*\ .  If units = box,
