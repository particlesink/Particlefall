...
* keyword = *norm* or *units* or *file* or *ave* or *overwrite* or *title1* or *title2* or *title3* or *write\_ts* or *std*
...
resulting bin averages can be used by other :ref:`output commands <howto_8>` such as :doc:`thermo\_style custom <thermo_style>`, and can also be written to a file.
...
various :ref:`output commands <howto_8>`.  The values can
