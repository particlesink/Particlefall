...
Packfall commands as needed, e.g. to calculate  dump file output.
See this :ref:`howto section <howto_8>` for a summary of
various Packfall output options, many of which involve computes.
...
In Packfall, the values generated by a compute can be used in several
ways:
...
Code for new computes can be added to Packfall (see :doc:`this section <Section_modify>` of the manual) and the results of their
...
and what it does. The full list of computes defined in Packfall is on
:ref:`this page <cmd_5>`.
