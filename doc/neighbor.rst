...
These commands set parameters that affect the building of pairwise
...
default values below. The "neighbor\_skin" command is a wrapper for
"neighbor" that only takes the *skin* value as input and sets *style*
to *bin*\ .
...
may be much faster for the short-cutoff cases.  See the :doc:`communicate multi <communicate>` command for a communication option option that
