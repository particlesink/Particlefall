...
be controlled by a variable; see the :doc:`dump\_modify every <dump_modify_vtk>` command for details.

Only information for atoms in the specified group is dumped.  The
:doc:`dump\_modify thresh and region <dump_modify_vtk>` commands can also
...
.. warning::
   ...
   Unless the :doc:`dump\_modify sort <dump_modify_vtk>` option
...
:doc:`dump\_modify <dump_modify_vtk>` doc page for details.
...
The *id*\ , *mol*\ , *id\_multisphere*, *type*\ , *element*\ , *mass*\ , *vx*\ , *vy*\ , *vz*\ , *fx*\ , *fy*\ ,
...
each type via the :doc:`dump\_modify element <dump_modify_vtk>` command.
