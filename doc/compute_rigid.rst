...
* id = obligatory keyword for style multisphere/single
* id\_ms = multisphere id which command applies to for style multisphere/single
...
* property\_name = *xcm* or *vcm* or *fcm* or *torque* or *quat* or *angmom* or *omega* or *density* or *type* or *id* or *masstotal* or *inertia* or *ex\_space* or *ey\_space* or *ez\_space*
  ...
  .. parsed-literal::
       ...
       *clumptype* = multi-sphere type as defined in :doc:`fix paticleteplate/multisphere <fix_particletemplate_multisphere>` (1 value)
