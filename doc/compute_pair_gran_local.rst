...
.. warning::
   ...
   walls (see :doc:`fix mesh <fix_mesh>`) can be used.
...
if a :doc:`fix heat/gran <fix_heat_gran>` is used to compute  heat
...
.. warning::
   ...
   *force\_tangential*, *torque*\ , *history*\ , *contactArea*\ , *heatFlux*\ ,
