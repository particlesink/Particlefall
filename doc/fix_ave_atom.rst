...
per-atom averages can be used by other :ref:`output commands <howto_8>` such as the :doc:`fix ave/spatial <fix_ave_spatial>` or :doc:`dump custom <dump>` commands.
...
stored by this fix for access by various :ref:`output commands <howto_8>`.

This fix produces a per-atom vector or array which can be accessed by
various :ref:`output commands <howto_8>`.  A vector is
