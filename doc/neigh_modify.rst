...
* binsize\_value = bin size for neighbor list constrution (distance units)
...
pairwise neighbor lists. The "neigh\_settings" command is a wrapper of
"neigh\_modify" that sets *delay*\ =0. Its only, optional, parameter
